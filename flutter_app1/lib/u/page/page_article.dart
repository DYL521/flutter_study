...
import 'package:flutterapp1/http/api.dart';
import 'package:flutterapp1/ui/article_item.dart';
...
class _ArticlePageState extends State<ArticlePage> {
  ...
  Widget build(BuildContext context) {
    return Stack( //Stack 跟原生的帧布局很像
      children: <Widget>[
        ///正在加载
        Offstage(
          offstage: !_isHide, //是否隐藏=>View.GONE
        ...
        Offstage(
          ...
          child: new RefreshIndicator(
              child: ListView.builder( //命名构造函数，以下
                //@required 都是必传参数
                //条目数 +1代表了banner的条目
